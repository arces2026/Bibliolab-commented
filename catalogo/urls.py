...
from django.urls import path, include        # path() crea pattern URL; include() delega ad altri urls.py
...
from rest_framework.routers import DefaultRouter  # Router DRF per generare URL automaticamente
...
urlpatterns = [
    ...
    path('libri/<int:pk>/elimina/', views.LibroDeleteView.as_view(), name='elimina_libro'),
    ...
    path('api/libri/<int:pk>/', api_views.api_libro_dettaglio, name='api_libro_dettaglio'),
]
