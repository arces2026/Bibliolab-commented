...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-bibliolab-corso-arces-palermo-cambiare-in-produzione'
)
...
AUTH_PASSWORD_VALIDATORS = [
    {'NAME': 'django.contrib.auth.password_validation.UserAttributeSimilarityValidator'},  # no password simile all username
    {'NAME': 'django.contrib.auth.password_validation.MinimumLengthValidator'},            # minimo 8 caratteri
